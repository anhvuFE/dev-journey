...
export default function AboutIntro({
  ...
  return (
    <header className="mt-12 border-t border-border pt-10">
      ...
      {/* Tên: một dòng, không cho gãy chữ */}
      <h1 className="mt-6 whitespace-nowrap text-4xl font-extrabold uppercase leading-[1.02] tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
        {profile.name}
      </h1>
      ...
      <div className="mt-12 grid gap-x-14 gap-y-5 md:grid-cols-2 lg:gap-x-20">
        {body.map((p, i) => (
